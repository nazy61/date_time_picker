...
import 'src/datetime_picker_themes.dart';

export 'package:flutter_datetime_picker/src/datetime_picker_themes.dart';
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? DatePickerThemes(),
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    DatePickerThemes theme = widget.route.theme;
  ...
  Widget _renderPickerView(DatePickerThemes theme) {
  ...
  Widget _renderItemView(DatePickerThemes theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DatePickerThemes theme) {
